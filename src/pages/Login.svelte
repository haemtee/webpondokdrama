...
<div class="max-w-md mx-auto mt-20 bg-dracin-card p-8 rounded-2xl shadow-xl border border-gray-800">
    <h2 class="text-3xl font-bold mb-6 text-center text-dracin-primary">Welcome Back</h2>
    ...
    <p class="mt-6 text-center text-sm text-gray-400">
        Don't have an account? <a href="#/register" class="text-dracin-primary hover:underline">Register here</a>
    </p>
</div>
